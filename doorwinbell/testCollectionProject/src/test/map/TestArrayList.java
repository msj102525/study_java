...
//		Collection alist3 = new ArrayList();
		...
		alist.add("oralce"); // auto boxing
		alist.add(123);
		alist.add(45.6);
		
		System.out.println(alist/* .toString() */);
		
		// 저장 순번(index)가 있어서, 저장 객체 하나씩 취급할 수 있음
		...
		// 원하는 위치(index)의 객체정보도 변경할 수 있음 : set(index, Element)
		alist.add(2, new HashSet());
		System.out.println(alist);
		...
		// for문, for each문, toArray(), iterator() 사용 가능함
