...
public class StaticMethod {
	...
	public static void setValue(String v) {
		// static 메소드 안에는 this 레퍼런스가 없음 : 사용 못함
		value = v;
	}
	...
	public static void toUpper() {
		// java.lang.String가 제공하는 toUpperCase() 사용
	...
	public static void setChar(int index, char ch) {
		if(value != null && value.length() > 0) {
			...
			// java.lang.String 클래스에는 원하는 위치의 문자하나 변경하는 메소드 없음
			// String -> StringBuilder로 변경하고 setCharAt(index, ch) 사용하는 방법
			StringBuilder sb = new StringBuilder(value);
			sb.setCharAt(index, ch);
			value = sb.toString();
			// 또는 String -> char[] 문자하나 변경하고, 다시 String으로 바꿈
			char[] values = value.toCharArray();
			values[index] = ch;
