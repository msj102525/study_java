...
public class MethodSample {
	...
	public void hello(int no) {
		switch(no) {
		case 1: System.out.println("반갑습네다.");
		break;
		case 2: System.out.println("어서오라");
		break;
		case 3: System.out.println("환영함");
		break;
	...
	public int randomValue() {
		...
		// 반환할 값은 1개만 보낼 수 있음
		// return문은 메소드 안에서 맨 마지막에 딱 한번 실행되게 작성해야 함
	...
	public int limitRandom(int num1, int num2) {
		...
		System.out.println(min + " ~ " + max + "사이의 임의의 정수발생");
