...
public class TestObject {
	...
	public static void main(String[] args) {
		// 자바 언어로 만들어지는 모든 클래스는 java.lang.Object의 후손이다.
		// 즉, Object가 제공하는 메소드 모두 사용할 수 있다.
		Book book = new Book();
		...
		// getClass() => Class 리턴함 => 오버라이딩된 toString이 작동됨
		Class var = book.getClass();
//		String varStr = var.toString();
//		System.out.println("getClass : " + varStr);
		System.out.println("getClass : " + var);
	} // main

} // class

// 하나의 java파일 안에 클래스(파일명) 하나 작성이 원칙임
// 하나의 java파일 안에 클래스 여러 개 작성할 수도 있음
// 주의사항 : 파일명으로 사용된 클래스만 public class로 지정할 수 있음
