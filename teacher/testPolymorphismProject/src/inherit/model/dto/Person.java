...
public class Person implements java.io.Serializable {
	...
	static {
		//static 이 표기된 정적 필드(클래스변수) 초기화 처리
	}
	...
	//오버라이딩 : 부모가 제공하는 메소드를 후손이 다시 만들기 하는 것 (재작성)
	//규칙 1. 부모메소드의 반환형 메소드명(매개변수) 그대로 사용해야 함 : 변경 불가능임, 변경시 에러임
