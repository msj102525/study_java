...
//import java.lang.*;  //생략 가능, jvm 에 의해 컴파일시 자동 추가됨

public class ArraySample2 {
	
	//생성자(Constructor) : 기본생성자(매개변수 없는 생성자)와 매개변수 있는 생성자 작성해야 함
	//jvm 에 의해서 생성자가 없는 클래스를 컴파일할 때 기본생성자를 자동 추가함
	...
	public void arrayInit(int[] ar) {
		...
		printArray(ar);
		return;  //생략 가능함, jvm 에 의해 컴파일시 자동 추가됨
	}
	
	//배열을 출력하는 메소드
	public void printArray(int[] ar) {
		//매개변수 ar 이 null 을 받으면, null.length 작동됨 => NullPointerException 발생함
